...
| `set_field(hl, field, value)` | True | Routes to the matching `ArticleModel` setter. Fields: title, content, date, tags, excerpt_image, posts_folder, website_url, green, black. |
...
## `get_state(hl)` shape
`hl, title, content, date, tags, excerpt_image, excerpt_image_local, posts_folder, website_url, slug, green, black, title_color, length_short, links[], content_md, content_md_separators, content_md_separators_br, content_short, watermark`.
